    ...
    while True:
        ...
        if not ball_served:
            ...
            if platform_y - ball_y > 285:
                ...
                if direction_x == 1:
                    if (platform_y - ball_y) + ball_x <= 195:
                        bounce_to_right = True
                        bounce_to_left = False
                        distance = ball_x + (platform_y - ball_y - 5)
                    elif (platform_y - ball_y) + ball_x > 195:
                        bounce_to_left = True
                        bounce_to_right = False         
                        distance = (platform_y - ball_y - 5) - (195 - ball_x)
                if direction_x == -1:
                    if (platform_y - ball_y) <= ball_x:
                        ...
                        bounce_to_left = False
                        bounce_to_right = True         
                        distance = (platform_y - ball_y - 5) - ball_x    
